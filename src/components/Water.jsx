...
export default function Water({ waterLevel, handleLevelChange, watstars }) {
    ...
    return <>
        <img className="goose" src="https://loolooloo.vercel.app/goose.png" style={{ bottom: (waterLevel) * 60 + 90, left: waterLevel * 35 }}></img>
        <div className="water" style={{ height: (waterLevel) * 60, bottom: (waterLevel) * 60 + 160 }}></div>
        <div className="button-container">
        <p className = "watstar-count">{watstars}</p><img src = "https://loolooloo.vercel.app/watstar.png" className = "watstar"></img>
